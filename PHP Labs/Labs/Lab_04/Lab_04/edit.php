<?php include('./Db/UpdateRecord.php') ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <form method="POST" action="">
        ...
        <div class="mb-3">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="gender" id="female" value="F" <?php if ($gender == "F") {
                                                                                                        echo 'checked';
                                                                                                    } ?>>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="gender" id="male" value="M" <?php if ($gender == "M") {
                                                                                                    echo 'checked';
                                                                                                } ?>>
